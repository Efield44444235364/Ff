...
local function main()
	...
	Explorer.InitRightClick = function()
		...
		context:Register("TELEPORT_TO",{Name = "Teleport To จ้า", IconMap = Explorer.MiscIcons, Icon = "TeleportTo", OnClick = function()
			local sList = selection.List
		...
		context:Register("COPY_PATH",{Name = "Copy Path จ้า", IconMap = Explorer.ClassIcons, Icon = 50, OnClick = function()
			local sList = selection.List
			if #sList == 1 then
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Dark เด็ก",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by น้องฟิวจ้า",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
