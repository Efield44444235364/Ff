...
-- Tables
	...
	Tab:AddButton({
		Name = "Teleport To Private Lobby (In Dev)",
		Callback = function()
		Notify('IN DEV BITCH', "In dev to update this script pls wait", 'rbxassetid://4483345998', 7)
	...
	Tab:AddButton({
		Name = "Get The Best Weapon (You must to know what the best weapon first",
		Callback = function()
			GetBestTool()
		end
	})
